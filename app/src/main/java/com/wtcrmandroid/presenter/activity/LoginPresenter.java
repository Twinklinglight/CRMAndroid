...
import com.wtcrmandroid.http.retrofit2.data.LoginData;
...
public class LoginPresenter extends BasePresenter<List<LoginData>> {
    ...
    public void login() {
        ...
        post("http://192.168.0.7/api/Login/UserLogin", params);
