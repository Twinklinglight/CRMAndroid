...
public class TeamRankingAdapter extends BaseRecycleAdapter<SalesRankingRP, TeamRankingAdapter.ViewHolder> {
    ...
    protected void convert(ViewHolder holder, SalesRankingRP bean, int position) {
        holder.tvTeamName.setText(bean.getTeamname());
        holder.tvCaptain.setText("队长：" + bean.getTeamdesc());
        holder.tvPeopleNumber.setText("队员数量：" + bean.getRenshu());
