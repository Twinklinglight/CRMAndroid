...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_BG = Color.parseColor("#F5F6F7");
    private static int COLOR_TITLE_FONT = Color.parseColor("#939699");
...
/*
        ...
        //绘制title文字
        c.drawText(mDatas.get(position).getSuspensionTag(), 20, child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
